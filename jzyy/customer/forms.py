...
class JobSearchForm(forms.Form):
    title = forms.CharField(label_suffix='',label='标题',required=False,max_length=50,widget=forms.TextInput(attrs={'class': 'form-control form-control-sm ' }))
    description = forms.CharField(label_suffix='',label='描述',required=False,max_length=50,widget=forms.TextInput(attrs={'class': 'form-control form-control-sm ' }))
    create_date = forms.CharField(label_suffix='',label='创建日期',required=False,max_length=50,widget=forms.TextInput(attrs={'class': 'form-control form-control-sm ' }))
    operator = forms.CharField(label_suffix='',label='执行人',required=False,max_length=50,widget=forms.TextInput(attrs={'class': 'form-control form-control-sm ' }))
    status = forms.ChoiceField(label_suffix='',label='状态',choices = (('', '请选择'),('跟踪中', '跟踪中'),('完成', '完成'),('作废','作废')),widget=forms.Select(attrs={'class': 'form-control form-control-sm'  }),required=False)
