...
class User(models.Model):
    ...
    level = models.CharField(max_length=32,verbose_name='职级',choices = (('部门总', '部门总'),('副总', '副总'),('总助', '总助'),('职员','职员')),blank=True,null=True,default='职员')
    leader = models.ForeignKey('User',on_delete=models.CASCADE,verbose_name='领导',default=7) 
