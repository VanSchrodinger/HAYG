...
urlpatterns = [
    ...
    path('',include(('jzyy_notes.urls','jzyy_notes'),namespace='learning_logs')),
    path('users/',include(('users.urls','users'),namespace='users')),
    path('fileserver/',include(('fileserver.urls','fileserver'),namespace='fileserver')),
